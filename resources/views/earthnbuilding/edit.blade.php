        ...
        <div class="card mt-5 mb-5">
            ...
            <div class="card-body">
                ...
                {{ Form::open(['action' => ['EarthnbuildingController@update', $earthnbuilding->id], 'method' => 'put'])}}
                    ...
                    <div class="form-group">
                        {{Form::label('Latitude')}}
                        {{Form::number('lat', $earthnbuilding->lat, ['class' => 'form-control',  'step' => 'any', 'placeholder' => 'Latitude'])}}
                        ...
                        <div class="form-group">
                            ...
                            {{Form::number('long', $earthnbuilding->long, ['class' => 'form-control',  'step' => 'any', 'placeholder' => 'Longitude'])}}
